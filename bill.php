...
<!-- End Sidebar-->
  ...
  <div class="row justify-content-center mt-4">
    <div class="col-sm-12">
      <div class="card">
        <div class="text-end">
        <button type="button" class="btn btn-info rounded-pill m-2" data-bs-toggle="modal" data-bs-target="#bill_modal">
       Add Bill
         </button>
         </div>
      ...
      <form id="billform">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 mt-3">
                ...
                <select name="employees_id" id="employees_id" class="form-control employees_id">
